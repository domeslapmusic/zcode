...
function addFlash(postpone,minversion,path,width,height,node) {
	...
	var salign = '';
	var flvars = '';
	var allowedObjParams = ["menu","play","quality","scale","devicefont","bgcolor","loop","wmode","salign","base","allowscriptaccess"];
	var allowedEmbParams = ["menu","play","quality","scale","devicefont","bgcolor","loop","wmode","base","swliveconnect","allowscriptaccess"];
