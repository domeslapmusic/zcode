...
class cl.cay.effects.Basic{
        ...
        public static function WetFloor(mc:MovieClip,height:Number,margin:Number,alpha:Number):Void{
                
                if(height == null) height = 40;
                if(margin == null) margin = 0;
					 if(alpha == null) alpha = 70;
                ...
                var gradient_mc:MovieClip = reflection_mc.createEmptyMovieClip("gradient_mc",1);
					 Draw.GradientBox(gradient_mc,bmp.rectangle,[0,0],[alpha,0],Math.PI/2);
